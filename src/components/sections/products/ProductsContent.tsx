// src/components/sections/products/ProductsContent.tsx
"use client";
                ...
                <div className="flex flex-col md:flex-row justify-between items-end gap-8">
                    ...
                    <div className="bg-white p-1.5 rounded-full border border-gray-200 flex shadow-sm mx-auto md:mx-0">
                        <button
                            ...
                            className={`px-6 py-3 rounded-full text-sm font-medium transition-all ${activeTab === "Individuals"
                        ...
                        <button
                            ...
                            className={`px-6 py-3 rounded-full text-sm font-medium transition-all ${activeTab === "Business"
                                    ? "bg-brand-accent text-white shadow-md"
                                    : "text-gray-600 hover:text-brand-primary"
                                }`}
                        >
